...
class LaravelFirstPartyFacadeCatalogTest extends TestCase
{
    ...
    {
        $catalog = $this->app->make(LaravelFirstPartyFacadeCatalog::class);
    ...
    {
        $entry = $this->app->make(LaravelFirstPartyFacadeCatalog::class)->indexedByFacadeClass()[Cache::class];
    ...
    {
        $entry = $this->app->make(LaravelFirstPartyFacadeCatalog::class)->indexedByFacadeClass()[Route::class];
