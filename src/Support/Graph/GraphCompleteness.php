...
final class GraphCompleteness
{
    ...
    public static function limitations(): array
    {
        return [
            ...
            'Queued mailables (Mailable + ShouldQueue) are exported as Mailable nodes, not Job nodes.',
            ...
            'Broadcast channel closure callbacks export as BroadcastChannel nodes without HANDLED_BY; class-based channel auth uses join().',
        ];
    }
